...
module.exports = function(connectionString) {
  ...
  */
  ...
  function getMessagesForOptions(findOptions, callback){
    ...
    //always filter out those with a deleteflag
    findOptions.deleteflag = null;
  ...
  return {
    ...
    editMessage: function(updatedMessage, callback) {

      log.debug('Updating message with messageId[%s]', updatedMessage.id);

      var updates = setUpdateFields(updatedMessage);

      updateExistingMessage(updatedMessage.id,updates, callback);
    },
    ...
    deleteMessage: function(messageId, callback) {
      ...
      var updates = { deleteflag : true };

      updateExistingMessage(messageId,updates,callback);
    },
