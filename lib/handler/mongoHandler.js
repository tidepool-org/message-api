  ...
  return {
    ...
    getMessage: function (messageId, options, callback) {
      ...
      if (objectIdIsValid(messageId)) {
        ...
        messagesCollection.findOne(options, function (error, doc) {
          if (error) {
            return callback(error, null);
          } else if (doc) {
    ...
    getAllMessages: function (groupId, options, callback) {
      ...
      log.debug(
        'Finding all messages for group[%s] from[%s] to[%s]',
        groupId,
        options.start,
        options.end
      );
    ...
    getNotes: function (groupId, options, callback) {
      ...
      log.debug(
        'Finding all notes for group[%s] from[%s] to[%s]',
        groupId,
        options.start,
        options.end
      );
