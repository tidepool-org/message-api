...
function createServer(
  ...
  server.get(
    '/message/read/:msgid',
    checkToken,
    gatekeeperHandler.checkPermissionsFromMessage,
    messageApi.findById
  );
  server.get(
    '/read/:msgid',
  ...
  server.get(
    '/message/thread/:msgid',
    checkToken,
    gatekeeperHandler.checkPermissionsFromMessage,
    messageApi.getThread
  );
  server.get(
    '/thread/:msgid',
    checkToken,
  ...
  server.get(
    '/message/all/:groupid',
    checkToken,
    gatekeeperHandler.checkPermissionsFromGroup,
    messageApi.findAllById
  );
  server.get(
    '/all/:groupid',
    checkToken,
