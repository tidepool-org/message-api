...
var messagesService = function(envConfig, crudHandler, userApiClient, seagullHandler, metrics) {
...
function createServer(serverConfig, crudHandler, userApiClient, seagullHandler, metrics){
    ...
    server.get('/notes/:groupid?starttime&endtime', checkToken, messages.getNotes);
