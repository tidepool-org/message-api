  ...
  return {
    ...
    */
    ...
    findById : function(req, res, next) {
      ...
      crudHandler.getMessage(messageId, function(error,foundMessage){
        if (error){
          ...
          if(foundMessage) {
            resolveUserNames([foundMessage],'TODO',function(resolvedMessages){
      ...
      crudHandler.getAllMessages(groupId, start, end, function(error,messages){
        if (error){
          ...
          if (messages && messages.length>0){
            resolveUserNames(messages,'TODO',function(resolvedMessages){
    ...
    getNotes : function(req, res, next) {
      ...
      crudHandler.getNotes(groupId, function(error,messages){
        if (error){
