 ...
 */
module.exports = function(config, crudHandler, seagullHandler, metrics = undefined) {
  ...
  return {
    ...
    addThread : function(req, res, next) {
      ...
      if( !_.isEmpty(missing) ){
        ...
        var message = format.incomingMessage(req._tokendata.userid, req.params.groupid, req.body.message);
    ...
    replyToThread : function(req, res, next) {
      log.debug('replyToThread: params[%j], body[%j], url[%s], method[%s]', req.params, req.body, req.url, req.method);
    ...
    editMessage : function(req, res, next) {
      log.debug('editMessage: params[%j], body[%j], url[%s], method[%s]', req.params, req.body, req.url, req.method);
