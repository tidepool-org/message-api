...
(function() {
    ...
    server.get('/api/message/all/:patientid/:starttime/:endtime', messages.findAllById);
    server.get('/api/message/all/:patientid/:starttime', messages.findAllById);

    console.log('messages API server serving on port[%s]', config.port);
